...
namespace Optimization {
    ...
    class BacktrackingLineSearch {
        ...
        public:
            ...
            static double search(Func f, const std::array<double, N>& x, 
                                 const std::array<double, N>& d, 
                                 double alpha=1.0, double p=0.5, 
                                 double c=1e-4, bool verbose=false) {
                ...
                while (true) {
                    ...
                    if (verbose) {
                        std::cout << "  ↳ [Backtrack Iter " << std::setw(2) << iter << "] alpha: " << std::fixed << std::setprecision(6) << alpha 
