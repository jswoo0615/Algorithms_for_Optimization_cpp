        ...
        for (size_t i = 0; i < N_vars; ++i) {
            for (size_t j = 0; j < N_vars; ++j) {
                ...
                for (size_t k = 0; k < N_res; ++k) {
                    sum_h += J_res(static_cast<int>(k), static_cast<int>(i)) *
                             J_res(static_cast<int>(k), static_cast<int>(j));
                }
            ...
            for (size_t k = 0; k < N_res; ++k) {
                sum_g +=
                    J_res(static_cast<int>(k), static_cast<int>(i)) * r_val(static_cast<int>(k));
            }
