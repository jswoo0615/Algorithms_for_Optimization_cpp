                ...
                if constexpr (N_eq > 0) {
                    ...
                    for (size_t i = 0; i < N_vars; ++i) {
                        ...
                        for (size_t j = 0; j < N_vars; ++j) {
                            ...
                            H_GN(static_cast<int>(j), static_cast<int>(j)) += std::abs(J_eq(static_cast<int>(i), static_cast<int>(j))) * 0.1;
                        }
                    }
                }
                ...
                if constexpr (N_ineq > 0) {
                    ...
                    for (size_t i = 0; i < N_ineq; ++i) {
                        ...
                        for (size_t j = 0; j < N_vars; ++j) {
                            ...
                            H_GN(static_cast<int>(j), static_cast<int>(j)) += std::abs(J_ineq(static_cast<int>(i), static_cast<int>(j))) * 0.1;
                        }
                    }
                }
