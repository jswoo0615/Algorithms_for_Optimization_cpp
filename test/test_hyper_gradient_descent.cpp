...
TEST(HyperGradientDescentTest, SphereFunctionOptimization) {
    ...
    auto result =
        HyperGradientDescent::optimize<3>(SphereFunction{}, x_init, 0.05, 0.01, 1e-5, 5000, false);
...
TEST(HyperGradientDescentTest, RosenbrockFunctionOptimization) {
    ...
    auto result = HyperGradientDescent::optimize<2>(RosenbrockFunction{}, x_init, 0.0005, 1e-7,
                                                    1e-5, 100000, false);
